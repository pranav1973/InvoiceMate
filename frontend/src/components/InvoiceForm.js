...
class InvoiceForm extends React.Component {
  ...
  render() {
    ...
    <Form onSubmit={this.openModal}>
      <Button variant="danger" className="mb-3" onClick={this.logout} style={{  position: 'absolute',top : 0,right:0,transform: 'translate(-50%, 0)'}}>Logout</Button>
      <Row>
        <Col md={8} lg={9}>
          <Card className="p-4 p-xl-5 my-4 my-xl-5">
